...
export default function StatusPage() {
    ...
    if (id !== "private" && id !== "public") {
        return <div className='w-full h-full text-gray-300 flex justify-center items-center text-3xl bg-gradient-to-b from-black to-gray-800'>
    ...
    return (
        <StatusContextProvider>
            <div className="sm:p-2 w-full h-full flex justify-center bg-gradient-to-b from-black to-gray-800">
                <div className="flex flex-col w-full sm:w-80 sm:w-96 lg:w-[450px] h-full sm:rounded">
